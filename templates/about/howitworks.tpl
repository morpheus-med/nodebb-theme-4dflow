...
<div class='section narrow'>
  ...
  <img class='section' src="https://drive.google.com/thumbnail?id=0B15rbrurqSYTV0RJeFplWmdpOGM&authuser=0&v=1435206105914&sz=w1405-h617" width="678" />
  <div class='section'>
    <p>
      4D Flow is based on MRI phase contrast imaging. Phase images that are generated by
      an MRI are motion sensitive. Hence, the data can be used to acquire local velocities
